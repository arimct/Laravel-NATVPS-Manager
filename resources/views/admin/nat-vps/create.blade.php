        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.nat-vps.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="vps_id" id="vps_id" value="{{ old('vps_id') }}" required min="1"
                                   class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="ssh_port" id="ssh_port" value="{{ old('ssh_port', 22) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                       min="1" max="65535">
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Default SSH port is 22</p>
                                @error('ssh_port')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
