<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Statistics Cards (Requirement 10.1) -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Servers</dt>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 px-6 py-3">
                        <a href="{{ route('admin.servers.index') }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">
                            View all servers →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total NAT VPS</dt>
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $totalNatVps }}</div>
                                        <div class="ml-2 text-sm text-gray-500 dark:text-gray-400">
                                            ({{ $assignedVpsCount }} assigned)
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 px-6 py-3">
                        <a href="{{ route('admin.nat-vps.index') }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">
                            View all VPS →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 px-6 py-3">
                        <a href="{{ route('admin.users.index') }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">
                            View all users →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Unassigned VPS</dt>
            ...
            <!-- Server Health Indicators (Requirement 10.3) -->
                                    ...
                                    <div class="flex items-center justify-between p-3 rounded-lg {{ $issue['severity'] === 'error' ? 'bg-red-50 dark:bg-red-900/20' : 'bg-yellow-50 dark:bg-yellow-900/20' }}">
                                        <div class="flex items-center">
                                            @if($issue['severity'] === 'error')
                                                <span class="flex-shrink-0 w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                                            @else
                                                <span class="flex-shrink-0 w-2 h-2 bg-yellow-500 rounded-full mr-3"></span>
                                            @endif
                                            <div>
                                        ...
                                        <a href="{{ route('admin.servers.edit', $issue['server']) }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">
                                            View →
                                        </a>
                                    </div>
                                @endforeach
            ...
            <!-- Recent Activity (Requirement 10.2) -->
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
