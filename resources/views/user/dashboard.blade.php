                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('app.your_vps_instances') }}</h3>
                                <p class="text-3xl font-bold text-gray-900 dark:text-gray-100">{{ $assignedVpsCount }}</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('app.assigned_to_account') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('app.quick_access') }}</h3>
